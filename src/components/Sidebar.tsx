    ...
    <>
      ...
      {isOpenMobile && (
        <div
          ...
          className="fixed inset-0 z-[55] bg-black/80 backdrop-blur-sm lg:hidden transition-opacity"
        />
      )}

      {/* Sidebar Container */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-[60] w-72 max-w-[85vw] h-full bg-[#0C101B] border-r border-slate-800/80 flex flex-col transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="p-4 mx-3 mb-2 rounded-2xl bg-gradient-to-b from-slate-900/90 to-[#0A0E18] border border-slate-800/80 shadow-sm">
        ...
        {/* User Card */}
        <div className="p-3.5 mx-3 mb-3 border-t border-slate-800/80 flex items-center justify-between">
